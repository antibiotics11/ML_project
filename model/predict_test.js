...
tf.loadLayersModel("file://colorizer/model.json").then(function(model) {
	...
	generate_png("colorize-test1.png", grayscale_values[0].length, grayscale_values.length, rgb_values);
